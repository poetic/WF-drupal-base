...
foreach($topics as $topic) {
  ...
  $full_topics_link .= '<a class="w-hidden-tiny link blog-tag-link" href="/blog/'.$url.'">'.$term->name.'</a>';
}
?>
        <div class="w-col w-col-4 w-col-small-4">
          <div class="blog-article-block">
            <?php print render($content['field_image']);?>
            <div class="blog-date-tag-blog">
              <div class="date-text"><?php print $date->format('F j, Y'); ?></div><?php print $full_topics_link; ?>
            </div><a class="blog-title-link" href="<?php print $node_url; ?>"><?php print $title; ?></a>
