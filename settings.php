 ...
 * on Mon, 02 Nov 2015 22:47:14 +0000.
 *
...
if (isset($_SERVER['db_name'])) {
  ...
  */
  ...
  global $conf;
  $conf['install_profile'] = 'rune';
  $conf['file_public_path'] = 'sites/maker.com/files';
  $conf['file_temporary_path'] = 'sites/maker.com/private/temp';
  $conf['file_private_path'] = 'sites/maker.com/private/files';
  $drupal_hash_salt = '';
  $conf['clean_url'] = 1;
  $conf['aegir_api'] = 3;
...
$conf['features_default_export_path'] = 'sites/maker.com/modules/custom';
  ...
  if (is_readable('/var/aegir/platforms/rune/sites/maker.com/local.settings.php')) {
    include_once('/var/aegir/platforms/rune/sites/maker.com/local.settings.php');
  }
